...
const LeftSidebar = () => {
  return (
    <section className="custom-scrollbar bg-light900_dark200 light-border left-0 top-0 h-screen flex flex-col justify-between overflow-h-auto border-r p-6 pt-36 shadow-light-300 dark:shadow-none max-sm:hidden lg:w-[266px]">
      {/* Navigation Links */}
